...
class TestSmoke(unittest.TestCase):
    ...
    def test2_detector(self):
        detector = AcousticDetector([self.test_model_dir], [0.5], decoder_path='/opt/local/bin/ffmpeg')
...
class TestMP3(unittest.TestCase):
    ...
    def test1_smoke(self):
        mp3_detector = AcousticDetector([self.test_model_dir], [0.5], decoder_path='/opt/local/bin/ffmpeg')
        ...
        wav_detector = AcousticDetector([self.test_model_dir], [0.5], decoder_path='/opt/local/bin/ffmpeg')
